...
public class panelmaster5 : MonoBehaviour
{
    ...
    private panel_kaiten4[,] pk = new panel_kaiten4[4, 4];
    Answer5 ans;
    ...
    void Start()
    {
        ans = gameObject.AddComponent<Answer5>();
        ...
        for (a = 0; a < 4; a++)
        {
            for (b = 0; b < 4; b++)
            {
                ...
                panels[a, b] = aaa;
                pk[a, b] = aaa.GetComponent<panel_kaiten4>();
                pk[a, b].x = a;
                pk[a, b].y = b;
                States[a, b] = false;
