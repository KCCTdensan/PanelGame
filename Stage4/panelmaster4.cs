...
public class panelmaster4 : MonoBehaviour
{
    ...
    private panel_kaiten3[,] pk = new panel_kaiten3[4, 4];
    Answer4 ans;
    ...
    void Start()
    {
        ans = gameObject.AddComponent<Answer4>();
        ...
        for (a = 0; a < 4; a++)
        {
            for (b = 0; b < 4; b++)
            {
                ...
                panels[a, b] = aaa;
                pk[a, b] = aaa.GetComponent<panel_kaiten3>();
                pk[a, b].x = a;
                pk[a, b].y = b;
                States[a, b] = false;
