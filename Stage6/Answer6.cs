...
public class Answer6 : MonoBehaviour
{
    private bool[,] AnswerStates = new bool[5, 5];
    private bool[,] CurrentStates = new bool[5, 5];
    ...
    void Start()
    {
        ...
        textasset = Resources.Load("st6", typeof(TextAsset)) as TextAsset; //Resourcesフォルダから対象テキストを取得
